/*
 * package com.java.microservice.CloudGateway.controller;
 * 
 ...
 * 
 * import com.java.microservice.CloudGateway.model.AuthenticationResponse;
 * 
 ...
 * 
 * @GetMapping("/login") public ResponseEntity<AuthenticationResponse> login(
 * 
 * @AuthenticationPrincipal OidcUser oidcUser, Model model,
 * 
 * @RegisteredOAuth2AuthorizedClient("okta") OAuth2AuthorizedClient client ) {
 * AuthenticationResponse authenticationResponse =
 * AuthenticationResponse.builder() .userId(oidcUser.getEmail())
