/*
 * package com.java.microservice.OrderService.external.intercept;
 * 
 ...
 * org.springframework.security.oauth2.client.OAuth2AuthorizeRequest; import
 ...
 * 
 * public RestTemplateInterceptor( OAuth2AuthorizedClientManager
 * oAuth2AuthorizedClientManager) { this.oAuth2AuthorizedClientManager =
 ...
 * .withClientRegistrationId("internal-client") .principal("internal") .build())
